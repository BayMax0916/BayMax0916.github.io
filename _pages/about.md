...
- <span style="  background-color: #00369F; /* 背景颜色 */  color: #fff; /* 字体颜色 */  padding: 0.5px 5px;  border-radius: 3px;  font-size: 12px;  display: inline-block; ">CSRSWTC2025</span> Zhiwei Zhang, **Jiayu Zhang**, Jingtao Liu, Liling Wang and Changzhan Gu\*, “A Low-Complexity FMCW Radar Sensor for ShortRange Vital Sign Detection,” ***Cross Strait Radio Science & Wireless Technology Conference (CSRSWTC), 2025.*** <font color='Apricot'>(Best Paper Award)</font>
